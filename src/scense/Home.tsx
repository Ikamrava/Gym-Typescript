...
function Home({setSelectedPage}: Props) {
  ...
  return (
    <section id="home" className="  gap-16 bg-gray-20 md:py-32  md:h-full md:pb-0">
        ...
        <motion.div className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6 mt-10"
        onViewportEnter={() => setSelectedPage(Selectedpage.Home)}>
            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                <motion.div className="mt-10 flex items-center gap-8 mb-6"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.5 }}
        ...
        {isAboveMediumScreens && (
            <div className=" flex h-[100px] w-full bg-primary-100 justify-center items-center mt-8 ">
